...
var require_dist = __commonJS({
  "node_modules/@inertiajs/inertia/dist/index.js"(exports) {
    ...
    var s = { modal: null, listener: null, show: function(e2) {
      ...
      if (i2.style.backgroundColor = "white", i2.style.borderRadius = "5px", i2.style.width = "100%", i2.style.height = "100%", this.modal.appendChild(i2), document.body.prepend(this.modal), document.body.style.overflow = "hidden", !i2.contentWindow)
    ...
    function c(e2, t2, n2) {
      for (var i2 in void 0 === t2 && (t2 = new FormData()), void 0 === n2 && (n2 = null), e2 = e2 || {})
        Object.prototype.hasOwnProperty.call(e2, i2) && d(t2, l(n2, i2), e2[i2]);
      return t2;
    }
    function l(e2, t2) {
      return e2 ? e2 + "[" + t2 + "]" : t2;
    ...
    var w = function() {
      ...
      return n2.init = function(e3) {
        ...
        var e3;
        document.documentElement.scrollTop = 0, document.documentElement.scrollLeft = 0, this.scrollRegions().forEach(function(e4) {
          e4.scrollTop = 0, e4.scrollLeft = 0;
        ...
        this.page.scrollRegions && this.scrollRegions().forEach(function(t2, n3) {
          ...
          i2 && (t2.scrollTop = i2.top, t2.scrollLeft = i2.left);
        });
        ...
        var i2 = this, o2 = void 0 === n3 ? {} : n3, a2 = o2.method, l2 = void 0 === a2 ? exports.Method.GET : a2, d2 = o2.data, v2 = void 0 === d2 ? {} : d2, m2 = o2.replace, g2 = void 0 !== m2 && m2, w2 = o2.preserveScroll, y2 = void 0 !== w2 && w2, S2 = o2.preserveState, b = void 0 !== S2 && S2, E = o2.only, P = void 0 === E ? [] : E, I = o2.headers, x = void 0 === I ? {} : I, V = o2.errorBag, T = void 0 === V ? "" : V, L = o2.forceFormData, O = void 0 !== L && L, k = o2.onCancelToken, C = void 0 === k ? function() {
        } : k, M = o2.onBefore, A = void 0 === M ? function() {
        } : M, F = o2.onStart, R = void 0 === F ? function() {
        } : F, j = o2.onProgress, D = void 0 === j ? function() {
        } : j, B = o2.onFinish, q = void 0 === B ? function() {
        ...
        var Y = { url: _, method: l2, data: v2, replace: g2, preserveScroll: y2, preserveState: b, only: P, headers: x, errorBag: T, forceFormData: O, queryStringArrayFormat: K, cancelled: false, completed: false, interrupted: false };
        if (false !== A(Y) && function(e4) {
          ...
          this.activeVisit = r({}, Y, { onCancelToken: C, onBefore: A, onStart: R, onProgress: D, onFinish: q, onCancel: H, onSuccess: G, onError: X, queryStringArrayFormat: K, cancelToken: t.CancelToken.source() }), C({ cancel: function() {
            i2.activeVisit && i2.cancelVisit(i2.activeVisit, { cancelled: true });
          } }), function(e4) {
            f("start", { detail: { visit: e4 } });
          }(Y), R(Y), t({ method: l2, url: p(_).href, data: l2 === exports.Method.GET ? {} : v2, params: l2 === exports.Method.GET ? v2 : {}, cancelToken: this.activeVisit.cancelToken.token, headers: r({}, x, { Accept: "text/html, application/xhtml+xml", "X-Requested-With": "XMLHttpRequest", "X-Inertia": true }, P.length ? { "X-Inertia-Partial-Component": this.page.component, "X-Inertia-Partial-Data": P.join(",") } : {}, T && T.length ? { "X-Inertia-Error-Bag": T } : {}, this.page.version ? { "X-Inertia-Version": this.page.version } : {}), onUploadProgress: function(e4) {
            v2 instanceof FormData && (e4.percentage = Math.round(e4.loaded / e4.total * 100), function(e5) {
              f("progress", { detail: { progress: e5 } });
            }(e4), D(e4));
          } }).then(function(e4) {
            var t2;
            if (!i2.isInertiaResponse(e4))
              return Promise.reject({ response: e4 });
            var n4 = e4.data;
            ...
            if (i2.isInertiaResponse(e4.response))
              return i2.setPage(e4.response.data, { visitId: Z });
            ...
            if (!t.isCancel(e4)) {
              ...
              if (i2.activeVisit && i2.finishVisit(i2.activeVisit), n4)
                return Promise.reject(e4);
            }
          });
        }
        ...
        var t2, n3;
        if (void 0 === e3 && (e3 = "default"), !g)
          return null == (t2 = window.history.state) || null == (n3 = t2.rememberedState) ? void 0 : n3[e3];
    ...
    exports.App = f, exports.Head = h, exports.InertiaApp = f, exports.InertiaHead = h, exports.InertiaLink = m, exports.Link = m, exports.app = f, exports.createInertiaApp = function(e2) {
      try {
        ...
        return Promise.resolve(h2(p2.component).then(function(e3) {
          ...
          return function() {
            if (c2)
              return Promise.resolve(s2(t.createSSRApp({ render: function() {
      ...
      if ("object" == typeof e2 && null !== e2 && false === e2.__rememberable)
        return e2;
...
// dep:@inertiajs_inertia-vue3
var inertiajs_inertia_vue3_default = require_dist2();
export {
  inertiajs_inertia_vue3_default as default
};
